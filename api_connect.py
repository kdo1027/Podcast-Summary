...
def transcribe(audio_url, auto_chapters):
    ...
    transcript_response = requests.post(transcript_endpoint, json=transcript_request, headers=headers_assembyai)
...
def poll(transcript_id):
    ...
    polling_response = requests.get(polling_endpoint, headers=headers_assembyai)
...
def save_transcript(episode_id):
    ...
    data, error = get_transcription_result_url(audio_url, True)
